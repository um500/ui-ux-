...
export default function ContactPage() {
  ...
  return (
    <MainLayout>
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-background via-warm-blush to-light-sage overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              return (
                ...
                >
                  <div
                    className={`w-12 h-12 rounded-xl ${contact.color} flex items-center justify-center mb-4`}
                  >
